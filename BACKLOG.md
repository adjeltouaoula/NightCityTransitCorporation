...
- Investigate and repair the Mahir coach's front collision/traffic-detection volume and/or NCTC's ADE driving parameters: the bus can arrive at a stop too fast and drive into a vehicle ahead before braking. Rear underpass collision is fixed, but the front detection/collider and braking distance must reliably cause traffic avoidance and stopping.
