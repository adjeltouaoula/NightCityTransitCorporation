...
public class NCTCServiceBusController extends IScriptable {
  ...
  public func Bind(bus: ref<VehicleObject>) -> Bool {
    ...
    GameInstance.GetQuestsSystem(this.bus.GetGame()).SetFact(n"nctc_dev_build_revision", 37903);
    return true;
  }
  ...
  // r379c: same vanilla TrafficSystem primitive; maxEntityCount is explicitly Uint32.
  ...
  public func CountTrafficEntitiesInDepartureCorridor(forward: Vector4, rearDistance: Float, corridorDepth: Float, corridorWidth: Float) -> Int32 {
    ...
    ArrayPush(queryBoxPoints, origin - right * MaxF(corridorWidth * 0.50, 1.00));
    return Cast<Int32>(GameInstance.GetTrafficSystem(this.bus.GetGame()).FindEntitiesNearPlane(this.bus, queryBoxPoints, origin, right, MaxF(corridorWidth * 0.50, 1.00), Cast<Uint32>(32), trafficEntities));
  }
