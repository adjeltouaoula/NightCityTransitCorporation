...
local function log_service_loop(quests)
  ...
  local states = {
    ...
    [70] = "route loop: r376a H2 native arrival spline FAILED",
  ...
  if code == 29 or code == 30 or code == 36 or code == 43 or code == 47 or code == 48 or code == 49 or code == 50 or code == 51 or code == 52 or code == 53 or code == 54
    or code == 60 or code == 61 or code == 62 or code == 63 or code == 64 or code == 65 or code == 66 or code == 67 or code == 68 or code == 69 or code == 70 or code == 71 or code == 72 or code == 73 or code == 74 then
    command_extra = command_extra
