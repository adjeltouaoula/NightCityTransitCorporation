...
local function log_service_loop(quests)
  ...
  local states = {
    ...
    [72] = "route loop: r378e H2 extended-lane departure spline armed",
    [73] = "route loop: r378e H2 extended-lane departure spline active telemetry",
    [74] = "route loop: r378e H2 extended-lane spline -> low-speed native traffic handoff",
    [75] = "route loop: r378e H2 extended-lane departure spline FAILED"
  }
  local command_extra = ""
...
local function log_build_revision(quests)
  ...
  if revision == 37805 then
    log("NCTC runtime build=37805 r378e H2 extended exact-lane handoff")
