...
local function log_service_loop(quests)
  ...
  local states = {
    ...
    [72] = "route loop: r377b H2 lane-center slow departure spline armed",
    [73] = "route loop: r377b H2 lane-center slow departure spline active telemetry",
    [74] = "route loop: r377b H2 lane-center slow spline -> native traffic handoff",
    [75] = "route loop: r377b H2 lane-center slow departure spline FAILED"
  }
  local command_extra = ""
...
local function log_build_revision(quests)
  ...
  if revision == 37608 then
    log("NCTC runtime build=37608 r377b H2 lane-center slow handoff")
